...
import util.HttpParserUtils.Pair;

@Slf4j
public class HttpParserUtilsTest {
    @Test
    public void parseQueryString() {
        String queryString = "userId=javajigi";
        Map<String, String> parameters = HttpParserUtils.parseQueryString(queryString);
        assertThat(parameters.get("userId"), is("javajigi"));
        assertThat(parameters.get("password"), is(nullValue()));

        queryString = "userId=javajigi&password=password2";
        parameters = HttpParserUtils.parseQueryString(queryString);
        assertThat(parameters.get("userId"), is("javajigi"));
    ...
    public void parseQueryString_null() {
        Map<String, String> parameters = HttpParserUtils.parseQueryString(null);
        assertThat(parameters.isEmpty(), is(true));

        parameters = HttpParserUtils.parseQueryString("");
        assertThat(parameters.isEmpty(), is(true));
    ...
    public void parseCookies() {
        ...
        Map<String, String> parameters = HttpParserUtils.parseCookies(cookies);
    ...
    public void getKeyValue() throws Exception {
        Pair pair = HttpParserUtils.getKeyValue("userId=javajigi", "=");
        assertThat(pair, is(new Pair("userId", "javajigi")));
    }

    @Test
    public void getKeyValue_invalid() throws Exception {
        Pair pair = HttpParserUtils.getKeyValue("userId", "=");
    ...
    public void parseHeader() throws Exception {
        ...
        Pair pair = HttpParserUtils.parseHeader(header);
